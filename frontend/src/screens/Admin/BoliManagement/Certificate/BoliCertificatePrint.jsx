                        ...
                        <>
                          ...
                          {isData && isData?.modeOfDonation === '2' && (
                            <span className="grsay-text">
                              {' '}
                              रूपये नगद बोली स्वरूप सधन्यवाद प्राप्त हुये।{' '}
                            </span>
                          )}
                          {isData && isData?.modeOfDonation === 2 && (
                            <span className="gsray-text">
                          ...
                          {isData && isData?.modeOfDonation === '1' && (
                            <span className="grasy-text">
                              &nbsp; रूपये बैंक द्वारा बोली स्वरूप सधन्यवाद
                              प्राप्त हुये।{' '}
                            </span>
                          )}
                          {isData && isData?.modeOfDonation === 1 && (
                          ...
                          {isData && isData?.modeOfDonation === '3' && (
                            <span className="gsray-text">
                              &nbsp; रूपये चैक द्वारा बोली स्वरूप सधन्यवाद
                              प्राप्त हुये।{' '}
                            </span>
                          )}
                          {isData && isData?.modeOfDonation === 3 && (
                        ...
                        <>
                          {isData && isData.CHEQUE_NO && (
                            <span className="grsay-text">
                              ...
                              रूपये ऑनलाइन द्वारा बोली स्वरूप सधन्यवाद प्राप्त
                              हुये।
                            </span>
                          )}
                          {isData && isData.CHEQUE_NO === '' && (
                            <span span className="grsay-text">
                              ...
                              रूपये ऑनलाइन चैक द्वारा बोली स्वरूप सधन्यवाद
                              प्राप्त हुये।
                            </span>
                          )}
                        </>
